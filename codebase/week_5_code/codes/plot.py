...
x_values = np.arange(len(con_hidsmall)* 2)
x_values2 = np.arange(len(con_hidsmall))
...
#plt.plot(x_values2, con_hidsmall, label = 'Constant with input size 96, hidden size 50')
#plt.plot(x_values2, cond_hidsmall, label = 'Conductance with input size 96, hidden size 50')
plt.plot(x_values2, gru_hidsmall, label = 'Simple GRU with input size 96, hidden size 50')
